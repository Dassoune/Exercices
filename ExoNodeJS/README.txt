...
1/ On crée un dossier qui contiendras les fichiers de notre projet
...
6/ On crée un fichier data.json dans notre dossier afin d'y stocker nos données et de pouvoir les utiliser
